...
def load_hamer(checkpoint_path=DEFAULT_CHECKPOINT,map_location='cpu'):
    ...
    model = HAMER.load_from_checkpoint(checkpoint_path, strict=False, cfg=model_cfg,map_location=map_location)
